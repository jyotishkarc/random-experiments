...
options(scipen = 999)
J <- complete.LT(ALT_States[[1]])
J1 <- cbind(J[[1]][[1]],J[[1]][[2]],J[[1]][[3]])

colnames(J1) <- rep(c("q\\textsubscript{x}","l\\textsubscript{x}",
                  "L\\textsubscript{x}","e\\textsubscript{x}"),3)

kbl(J1, longtable = TRUE, booktabs = TRUE, caption = "Total Statistics", 
